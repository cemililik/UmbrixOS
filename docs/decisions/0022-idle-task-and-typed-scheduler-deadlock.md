...
- **2026-04-28 — first-rider Sub-rider closes (T-012, commit `<TBD-commit-3>`).** The 2026-04-22 first rider's *Sub-rider* set the WFI-activation precondition as the conjunction "T-009 (time source) **and** T-012 (IRQ delivery)". T-009 closed on 2026-04-23 (commit `39fb66c`); [T-012](../analysis/tasks/phase-b/T-012-exception-and-irq-infrastructure.md) closes today, fulfilling both halves:
