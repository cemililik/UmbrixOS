...
- **Active task:** [T-003 — IPC primitives](../analysis/tasks/phase-a/T-003-ipc-primitives.md) (status: **In Progress**).
...
- ADR-0017 Accepted: `send` + `recv` + `notify`, fixed-size 4-word `Message`, ≤ 1 cap per message, `reply_recv` and badge scheme deferred to ADR-0018. T-003 implementation in progress.
