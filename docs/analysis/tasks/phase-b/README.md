...
| [T-008](T-008-architecture-docs.md) | Architecture docs (scheduler.md + ipc.md + hal.md/overview.md updates) | B0 | In Review (2026-04-27) |
| [T-009](T-009-timer-init-cntvct.md) | Timer init + `CNTVCT_EL0` measurement | B0 | Done (2026-04-27) |
| [T-011](T-011-missing-tests-bundle.md) | Missing tests bundle (ReceiverTableFull + slot-reuse + ipc_send_and_yield + start_prelude + cap-table sweep) | B0 | In Review (2026-04-27) |
...
| [T-013](T-013-el-drop-to-el1.md) | EL drop to EL1 in boot (boot.s asm extension + `current_el` HAL helper) | B1 | In Review (2026-04-27) |
