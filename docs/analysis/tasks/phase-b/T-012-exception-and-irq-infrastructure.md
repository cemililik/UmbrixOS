...
- [x] Task status updated to `In Review`; ADR-0022 first rider's *Sub-rider* gains a closure paragraph; [`docs/roadmap/current.md`](../../../roadmap/current.md) updated.
